			...
			<div>
				...
				<div className="mobile-menu" style={{'transform': this.state.showMobileMenu? 'translate(256px, 0)' : 'translate(0, 0)'}}>
					<ul className="mobile-navigation">
							...
							<li className="mobile-navigation-item">
								<a href="#/" className="mobile-navigation">关于我们</a>
							...
							<li className="mobile-navigation-item">
								<a href="#/" className="mobile-navigation">公司新闻</a>
								<ul className="mobile-sub-navigation">
									<li>
										<a href="#/">企业新闻</a>   
									</li>
							...
							<li className="mobile-navigation-item">
								<a href="#/" className="mobile-navigation">产品展示</a>   
							</li>
							<li className="mobile-navigation-item">
								<a href="#/" className="mobile-navigation">客户服务</a>   
							</li>
							<li className="mobile-navigation-item">
								<a href="#/" className="mobile-navigation">招贤纳士</a>   
							</li>
							<li className="mobile-navigation-item">
								<a href="#/" className="mobile-navigation">案例展示</a>   
							</li>
							<li className="mobile-navigation-item">
								<a href="#/" className="mobile-navigation">联系我们</a>   
							</li>
						</ul>
				</div>
			</div>
