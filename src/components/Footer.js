			...
			<footer>
			   <div className="footer-container">
			        <div className="inner-footer-container">
			        	<div className="footer-block footer-block-left">
			            	<h3>联系我们</h3>
			            ...
			            <div className="footer-block footer-block-right">
			            	...
			            	<ul className="follow-info">
						    	<li><i className="fa fa-weibo" aria-hidden="true"></i>微博: 13810385469</li>
							  	<li><i className="fa fa-weixin" aria-hidden="true"></i>微信: 15806550699</li>
							  	<li><i className="fa fa-qq" aria-hidden="true"></i>QQ: 13963992580</li>
							</ul>
			            </div>
			        </div>
			        <div className="inner-footer-container">
			        	<div className="footer-block footer-block-left">
			            	...
			            	<div className="message">
							    ...
							    <p><textarea rows="4" className="" placeholder="留言内容"></textarea></p>
							    <p><button className="btn">发送</button></p>
							</div>
			            </div>
			            <div className="footer-block footer-block-right">
			            	<h3>用力扫我</h3>
			            	<img src={require("../img/qrhome.png")} alt="" />
			            </div>
			        </div>
